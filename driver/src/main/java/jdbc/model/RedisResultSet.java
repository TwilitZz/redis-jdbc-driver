...
public class RedisResultSet implements ResultSet {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RedisResultSet.class);
    ...
    public String getString(int columnIndex) throws SQLException {
        this.checkClosed();
        LOGGER.info("getString(%s)", columnIndex);
    ...
    public boolean getBoolean(int columnIndex) throws SQLException {
        ...
        if ("0".equals(r) || "false".equals(r)) {
            ...
            LOGGER.info("Cannot convert " + r + " into a boolean.");
    ...
    public String getCursorName() throws SQLException {
        LOGGER.info("getCursorName not implemented");
    ...
    public Object getObject(int columnIndex) throws SQLException {
        LOGGER.info("getObject not implemented");
    ...
    public Reader getCharacterStream(int columnIndex) throws SQLException {
        LOGGER.info("getCharacterStream not implemented");
    ...
    public void setFetchSize(int rows) throws SQLException {
        LOGGER.info("setFetchSize not implemented");
    ...
    public void updateRef(int columnIndex, Ref x) throws SQLException {
        LOGGER.info("updateRef not implemented");
    ...
    public void updateBlob(int columnIndex, Blob x) throws SQLException {
        LOGGER.info("updateBlob not implemented");
    ...
    public void updateClob(int columnIndex, Clob x) throws SQLException {
        LOGGER.info("updateClob not implemented");
    ...
    public void updateArray(int columnIndex, Array x) throws SQLException {
        LOGGER.info("updateArray not implemented");
    ...
    public RowId getRowId(int columnIndex) throws SQLException {
        LOGGER.info("getRowId not implemented");
    ...
    public void updateRowId(int columnIndex, RowId x) throws SQLException {
        LOGGER.info("updateRowId not implemented");
    ...
    public int getHoldability() throws SQLException {
        LOGGER.info("getHoldability not implemented");
        throw new SQLFeatureNotSupportedException("getHoldability not implemented");
    }

    @Override
    public boolean isClosed() throws SQLException {
        LOGGER.info("isClosed = %s", isClosed);
        return this.isClosed;
    }

    @Override
    public void updateNString(int columnIndex, String nString) throws SQLException {
        LOGGER.info("updateNString not implemented");
    ...
    public void updateNClob(int columnIndex, NClob nClob) throws SQLException {
        LOGGER.info("updateNClob not implemented");
    ...
    public NClob getNClob(int columnIndex) throws SQLException {
        LOGGER.info("getNClob not implemented");
    ...
    public SQLXML getSQLXML(int columnIndex) throws SQLException {
        LOGGER.info("getSQLXML not implemented");
    ...
    public void updateSQLXML(int columnIndex, SQLXML xmlObject) throws SQLException {
        LOGGER.info("updateSQLXML not implemented");
    ...
    public Reader getNCharacterStream(int columnIndex) throws SQLException {
        LOGGER.info("getNCharacterStream not implemented");
    ...
    public void updateNCharacterStream(int columnIndex, Reader x, long length) throws SQLException {
        LOGGER.info("updateNCharacterStream not implemented");
    ...
    public <T> T unwrap(Class<T> iface) throws SQLException {
        try {
            ...
            LOGGER.info("Unable to unwrap to %s" + iface);
